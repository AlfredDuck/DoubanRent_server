...
var html = 
'<div id="email_head"><h1>SILENT</h1><h4>SEND Anonymous Message \nTO Your Friends</h4></div>' +
'<div id="message"><p>You Got A Message From A Friend:</p><p>balabalabala</p></div>';
...
var mailOptions = {
    ...
    text:      "This mail comes from my mail robot",                          // 文本内容
    html:      html                    // html内容
}
//开始发送邮件
